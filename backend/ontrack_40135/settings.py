"""
Django settings for ontrack_40135 project.
...
ROOT_URLCONF = 'ontrack_40135.urls'
...
WSGI_APPLICATION = 'ontrack_40135.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ontrack_40135 API",
    "DESCRIPTION": "API documentation for ontrack_40135 App",
    "VERSION": "v1",
}
